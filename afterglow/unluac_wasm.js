/* @ts-self-types="./unluac_wasm.d.ts" */
 ...
 * @returns {any}
 */
export function decompile(bytes, options) {
    const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.decompile(ptr0, len0, options);
    if (ret[2]) {
 ...
 * @returns {any}
 */
export function decompileRich(bytes, options) {
    const ptr0 = passArray8ToWasm0(bytes, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.decompileRich(ptr0, len0, options);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
 ...
 * @returns {any}
 */
export function supportedOptionValues() {
    const ret = wasm.supportedOptionValues();
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('unluac_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
